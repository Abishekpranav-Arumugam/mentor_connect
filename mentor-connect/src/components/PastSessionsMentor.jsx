...
const PastSessionsMentor = () => {
  const sessions = [
    { id: 101, mentee: "Rahul Sharma", date: "Oct 25, 2023", time: "10:00 AM", topic: "React Hooks Basics", duration: "45 mins", status: "Completed" },
    { id: 102, mentee: "Priya Patel", date: "Oct 28, 2023", time: "02:00 PM", topic: "Career Guidance", duration: "30 mins", status: "Completed" },
    { id: 103, mentee: "Amit Kumar", date: "Nov 02, 2023", time: "11:00 AM", topic: "Project Review", duration: "60 mins", status: "Cancelled" },
    { id: 104, mentee: "Rahul Sharma", date: "Nov 05, 2023", time: "04:00 PM", topic: "State Management", duration: "50 mins", status: "Completed" },
  ];

  return (
    <div className="classic-animated-bg">
      <div className="mb-4 position-relative z-1">
        <h2 className="classic-title display-6">Session History</h2>
        <p className="classic-text-muted">Archives of your mentorship journey.</p>
      </div>
        ...
        <div className="table-responsive">
          <table className="table mb-0" style={{borderCollapse: 'separate', borderSpacing: '0'}}>
            <thead style={{background: 'rgba(44, 62, 80, 0.05)'}}>
              <tr>
                <th className="py-4 ps-4 text-uppercase small text-muted border-0">Student</th>
                ...
                <tr key={session.id} style={{background: index % 2 === 0 ? 'rgba(255,255,255,0.4)' : 'transparent'}}>
                  <td className="ps-4 py-3 align-middle border-bottom border-light">
                    <div className="d-flex align-items-center">
                        <div className="rounded-circle bg-white shadow-sm d-flex justify-content-center align-items-center me-3" style={{width: '40px', height: '40px', color: '#2c3e50', fontWeight: 'bold'}}>
                            {session.mentee.charAt(0)}
                        </div>
                        <span className="fw-bold text-dark">{session.mentee}</span>
                    </div>
                  </td>
...
export default PastSessionsMentor;
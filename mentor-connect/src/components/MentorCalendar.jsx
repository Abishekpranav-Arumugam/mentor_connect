...
import { FaEnvelope, FaBriefcase, FaClock, FaArrowLeft, FaUserTie } from 'react-icons/fa';
import '../styles/ClassyTheme.css';

const MentorCalendar = () => {
  const location = useLocation();
  const navigate = useNavigate();
  // Removed 'profilePicture' destructuring as it wasn't used
  const { calendlyUrl, fullName, faculty, areaInterested, experience, email } = location.state || {}; 

  if (!calendlyUrl) {
    navigate('/mentee/dashboard/view-mentors');
    return null;
  }
